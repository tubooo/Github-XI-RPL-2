...
//Proses belah ketupat
elseif($pilih == "Belah Ketupat"){
    if($pilih1 == "Luas"){  
        $hasil = $sisi + $sisi; 
    }
    elseif($pilih1 == "Keliling"){
...
//Proses trapesium
elseif($pilih == "Trapesium"){
    if($pilih1 == "Luas"){       
    }
    elseif($pilih1 == "Keliling"){
        $hasil = $sisi * $sisi * $tinggi;
    }
}
}
?>
...
<html lang="en">
  ...
  <body>
   ...
   <h4>4. Belah Ketupat</h4>
   <p>Rumus mencari luas = sisi x sisi</p>
   <h4>5. Trapesium</h4>
   <p>Rumus mencari luas = sisi x tinggi</p>
   <p>Rumus mencari keliing = sisi + sisi2 + tinggi</p>
   <h4>6. Lingkaran</h4>
   <p>Rumus mencari luas = 2 x phi x r</p>
   <p>Rumus mencari keliling = phi x r x r</p>
  </body>
</html>